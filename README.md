...
![Version](https://img.shields.io/badge/version-1.20.10-blue)
...
- **Media Kit** protetto: solo utenti approvati; **ricerca** titolo/descrizione, **ordinamento** (titolo, data, lingua), conteggio risultati, **elenco compatto** per asset (chip classificazione, titolo, lingua, download), **download multiplo ZIP** (se l’estensione PHP Zip è disponibile)
